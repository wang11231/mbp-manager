...
public class ChineseCharacterUtil {
    ...
    public static String convertHanzi2PinyinOneLetter(String sourceStr){
        if(StringUtils.isBlank(sourceStr)){
            return null;
        }
        return convertHanzi2Pinyin(sourceStr,false).substring(0, 1).toLowerCase();
    }
    ...
    public static void main(String[] args) {
        String str= "我爱你中国";
        System.out.println(convertHanzi2Pinyin(str.substring(0,1),false).toLowerCase());
    }
}