...
public class PhotoUtil {
     ...
     * @param height 图片高
     */
    public PhotoUtil(int width, int height) {
        this.width = width;
        this.height = height;
        this.createCode();
    }
     ...
     */
    public PhotoUtil(int width, int height, int codeCount, int lineCount) {
        this.width = width;
        this.height = height;
...
//        Font font = new Font("Times New Roman", Font.ROMAN_BASELINE, fontHeight);
    ...
    public static void main(String[] args) {
        /*PhotoUtil vCode = new PhotoUtil(100, 30, 4, 120);
        try {
