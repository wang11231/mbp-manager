...
public enum IdGenerator {
    ...
    public synchronized String nextId() {
        ...
        long prefix = (datacenterId << datacenterIdShift) | (workerId << workerIdShift) | sequence;

        String timeStuff = DateFormatUtils.format(timestamp, "yyyyMMddHHMMssSSS");

        return  prefix + timeStuff;
    }
