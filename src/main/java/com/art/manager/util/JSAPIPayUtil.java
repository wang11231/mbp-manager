...
public class JSAPIPayUtil {
     ...
     * @return
     */
    public static Map<String, String> webserviceRequest(String xml, String url){
        JaxWsDynamicClientFactory dcf = JaxWsDynamicClientFactory.newInstance();
        Client client = dcf.createClient(url);
        Object[] objects = new Object[0];
        Map<String, String> map = new HashMap<>();
        try {
            String interfaceNo = "001001";
            objects = client.invoke("insureService", interfaceNo, xml);
            String payXml = (String) objects[0];
            log.info("返回的报文" + payXml);
            map = xmlToMap(payXml);
